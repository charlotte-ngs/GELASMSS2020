...
In the remaining chapters, different approaches for the prediction of GBVs are described. Chapter 4 gives a description of the multiple linear regression model and how it was tried to be used for GBV prediction by [@Meuwissen2001]. Chapter 5 introduces BLUP methodology in the context of predicting GBVs. In Chapter 6 the method called LASSO is introduced. Interestingly enough, this method is used very seldom in the area of animal breeding. Last but not least, Chapter 7 makes an excursion into Bayesian estimation approaches. The Bayesian methods are important because they are used in practical breeding programs of Swiss Dairy cattle. 
