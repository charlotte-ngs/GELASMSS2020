...
The priors of the variance componetnes $\sigma_e^2$ and $\sigma_u^2$ were assumed to be independent scaled inverted chi-square ($\chi^2$) distributions such that 
