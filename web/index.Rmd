...
vec_topics_schedule[which(Datum == format(as.Date("2020/04/20"), "%d.%m"))] <- "Genetic Groups"
vec_topics_schedule[which(Datum == format(as.Date("2020/04/27"), "%d.%m"))] <- "Longitudinal Data"
...
vec_topics_addmat[which(Datum == format(as.Date("2020/03/23"), "%d.%m"))] <- paste0("[Recording of Lecture 06](https://youtu.be/2d0YjIoUWPE)")  



# https://youtu.be/2d0YjIoUWPE
