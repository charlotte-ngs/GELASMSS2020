...
- [751-6212-00L Genetic Evaluation of Lifestock](http://www.vorlesungsverzeichnis.ethz.ch/Vorlesungsverzeichnis/lerneinheit.view?lerneinheitId=135453&semkez=2020S&lang=en)
...
vec_topics_schedule[which(Datum == format(as.Date("2020/02/24"), "%d.%m"))] <- "Multiple Linear Regression"
...
vec_topics_notes[which(Datum == format(as.Date("2020/02/17"), "%d.%m"))] <- paste0("[](", s_cn_asm_url, ")") 
vec_topics_notes[which(Datum == format(as.Date("2020/02/24"), "%d.%m"))] <- paste0("[](", s_cn_asm_url, ")") 
